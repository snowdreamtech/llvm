...
## [19.1.7](https://github.com/snowdreamtech/llvm/compare/debian-v19.1.7...debian-v19.1.7) (2026-08-11)


### 🐛 Bug Fixes

* remove static version defaults from OCI image labels to use variable injection exclusively ([da5645a](https://github.com/snowdreamtech/llvm/commit/da5645ad4d48467290235abbbd9f31ba70bf690f))


### ♻️ Miscellaneous Chores

* merge upstream/dev ([a81f842](https://github.com/snowdreamtech/llvm/commit/a81f8420398fab65e9f86ce1bb1fe205c339aaf3))
* release main ([c9db13e](https://github.com/snowdreamtech/llvm/commit/c9db13ecc5033081c703e996d33c7503860ec15e))
* release main ([5a92edb](https://github.com/snowdreamtech/llvm/commit/5a92edb4ba76b04ee6de7369e9471f785849a7ae))
* **release:** deduplicate CHANGELOG headers ([a186680](https://github.com/snowdreamtech/llvm/commit/a186680625ac23b3ebbdf41e75a7370f38e03d22))
* sync debian build matrix and documentation with upstream ([0d6e613](https://github.com/snowdreamtech/llvm/commit/0d6e6132c84a368f5b64b9144d9c7d3b7292d746))
* update debian base image to 13.6.0 ([5f885d5](https://github.com/snowdreamtech/llvm/commit/5f885d5a771f06d449533f2f3c619d27444822f5))

## [19.1.7](https://github.com/snowdreamtech/llvm/compare/debian-v19.1.7...debian-v19.1.7) (2026-07-09)
